...
"""
🤖 Instagram Views Telegram Bot - Complete (Admin Panel Fixed)
- 1 Refer = 1 Credit, 1 Credit = 500 Views
- New user bonus: +1 Credit
- Force join (1 channel + 1 group)
...
def main():
    ...
    print("🤖 Bot is running with Admin Panel (fixed)!")
